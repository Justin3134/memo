      ...
      {video.status === "failed" ? (
          ...
          <div className="text-center px-6">
            ...
            <p className="text-[11px] text-muted-foreground leading-relaxed max-w-xs">
              {video.errorMessage?.includes("task_id")
                ? "Video generation failed. Check your configuration."
        ...
        <>
          ...
          <div className="text-center px-6">
            ...
            <p className="text-[11px] text-muted-foreground leading-relaxed max-w-xs">
              Creating a personalized video for this topic. This usually takes 2–4 minutes.
            </p>
          </div>
    ...
    <MemoLayout>
      <div className="max-w-4xl mx-auto animate-fade-in-up">
        ...
        <div className="flex items-center gap-2.5 mb-1">
          ...
          <span className="text-[9px] font-medium text-muted-foreground uppercase tracking-wider bg-muted px-1.5 py-0.5 rounded">AI-powered</span>
        </div>
          ...
          <div className="bg-card rounded-lg border border-border overflow-hidden mb-6">
            ...
            <div className="p-5">
              ...
              <p className="text-[12px] text-muted-foreground leading-relaxed mb-2">
                Generated based on signals detected in {patient?.name ?? "your patient"}'s recent call.
              </p>
            ...
            <div className="aspect-video bg-muted flex flex-col items-center justify-center gap-3">
              ...
              <p className="text-[12px] text-muted-foreground text-center max-w-xs leading-relaxed px-6">
                {latestGuidanceTopic
                  ...
                  : "A personalized video will be generated after a call where the patient expresses emotions or health concerns."}
              </p>
            </div>
            <div className="p-5">
              <p className="text-[10px] font-semibold text-primary uppercase tracking-wide mb-1">Latest Guidance Video</p>
              ...
              <p className="text-[12px] text-muted-foreground leading-relaxed">
                Videos are generated automatically after each call when emotional cues or health concerns are detected.
              </p>
            </div>
          </div>
        ) : null}
